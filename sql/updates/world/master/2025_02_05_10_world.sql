...
UPDATE `creature_template` SET `npcflag`=3, `AIName`='SmartAI' WHERE `entry` IN(213620, 213625);
...
-- sai
DELETE FROM `smart_scripts` WHERE `entryorguid` IN(213620, 213625);
INSERT INTO `smart_scripts` (`entryorguid`, `source_type`, `id`, `link`, `event_type`, `event_phase_mask`, `event_chance`, `event_flags`, `event_param1`, `event_param2`, `event_param3`, `event_param4`, `event_param5`, `event_param_string`, `action_type`, `action_param1`, `action_param2`, `action_param3`, `action_param4`, `action_param5`, `action_param6`, `action_param7`, `target_type`, `target_param1`, `target_param2`, `target_param3`, `target_param4`, `target_x`, `target_y`, `target_z`, `target_o`, `comment`) VALUES 
(213620, 0, 0, 0, 10, 0, 100, 0, 1, 30, 0, 0, 0, '', 33, 228585, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 0, 'Within 1-30 range give kill credit'),
(213625, 0, 0, 0, 10, 0, 100, 0, 1, 30, 0, 0, 0, '', 33, 228585, 0, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 0, 'Within 1-30 range give kill credit');

-- creature_text

UPDATE `quest_template` SET `Flags`=(1048576|33554432|268435456), `FlagsEx`=0x04000000 WHERE `id` IN(78713, 81930);