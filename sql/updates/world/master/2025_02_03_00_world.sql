...
DELETE FROM `creature` WHERE `id` IN(198401, 198393, 189077);
...
(@CGUID+5, 189077, 0, 1519, 4411, '0', 0, 19176, 0, -1, 0, 1, -8640.56, 1328.11, 5.31581, 5.0487, 120, 0, 0, 100, 0, NULL, NULL, NULL, NULL, '', NULL, 46702);
