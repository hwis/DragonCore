...
enum Races
{
    ...
    RACE_HARRONIR_ALLIANCE            = 86, // TITLE Harronir DESCRIPTION Harronir (Alliance) (RaceMask bit 20)
    //RACE_ROSTRUM_AIRSHIP            = 87,
    RACE_HARRONIR_HORDE               = 91, // TITLE Harronir DESCRIPTION Harronir (Horde) (RaceMask bit 19)
};
